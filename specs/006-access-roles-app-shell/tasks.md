...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [DEV-0054](development/DEV-0054.md) | DES-06-CMP-001 | sec_role | repository_and_dataverse_solution | local_interactive | security-solution-target | reuse_if_valid | microsoft-learn, msal-python, dataverse-web-api, power-platform-cli, dataverse-mcp | agent | — | in_progress |
...
| [DEV-0056](development/DEV-0056.md) | DES-06-CMP-003 | sec_role | repository_and_dataverse_solution | local_interactive | security-solution-target | reuse_if_valid | microsoft-learn, msal-python, dataverse-web-api, power-platform-cli, dataverse-mcp | agent | — | in_review |
